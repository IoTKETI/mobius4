...
| 4.12.0 | 2026-08-08 | **DELETE honours `rcn` 4/5/6/8** (`TS-0001:8.1.2` Table 8.1.2-1) — the response can now carry the child resources, or references to them, as they were just before removal. Same nesting, `lvl`/`lim` and truncation rules as the equivalent retrieve. Additive: the default delete still returns nothing | — |
